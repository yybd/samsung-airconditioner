...
(function ($) {
  $.DateTimePicker.i18n["he"] = $.extend($.DateTimePicker.i18n["he"], {
  ...
  shortDayNames: ["א", "ב", "ג", "ד", "ה", "ו", "ז"],
  fullDayNames: ["ראשון", "שני", "שלישי", "רביעי", "חמישי", "שישי", "שבת"],
  shortMonthNames: ["ינואר", "פבואר", "מרץ", "אפריל", "מאי", "יוני", "יולי", "אוגוסט", "ספטמבר", "אוקטובר", "נובמבר", "דצמבר"],
  fullMonthNames: ["ינואר", "פבואר", "מרץ", "אפריל", "מאי", "יוני", "יולי", "אוגוסט", "ספטמבר", "אוקטובר", "נובמבר", "דצמבר"],

  titleContentDate: "הגדר תאריך",
  titleContentTime: "הגדר שעה",
  titleContentDateTime: "הגדר תאריך ושעה",

  setButtonContent: "הגדר",
  clearButtonContent: "נקה",
